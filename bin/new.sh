...
python $BINPATH/../python-skeleton/sub.py setup.py $AUTHOR $NAME
...
python $BINPATH/../python-skeleton/sub.py tests.py $AUTHOR $NAME
mv tests.py $BASEPATH/$NAME/tests/$NAME_tests.py
